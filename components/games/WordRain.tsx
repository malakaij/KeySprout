    ...
    <div className="flex flex-col items-center gap-4">
      ...
      {(gameState === 'playing' || gameState === 'paused') && (
        <input
          ...
          className="w-full max-w-2xl bg-paper border-[3px] border-ink rounded-2xl px-4 py-3 text-ink font-mono text-lg placeholder-ink/30 focus:outline-none shadow-ink-sm"
        />
      )}
    </div>
  )
